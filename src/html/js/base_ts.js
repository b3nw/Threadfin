...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.general}}", "ssdp,tuner,epgSource,epgCategories,epgCategoriesColors,dummy,dummyChannel,ignoreFilters,api"));
