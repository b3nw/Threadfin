...
Versioning follows the upstream Threadfin scheme where practical (`major.minor.patch` app version in `threadfin.go`).

This repository is a maintenance fork of [Threadfin/Threadfin](https://github.com/Threadfin/Threadfin). Upstream development has stopped; historical beta notes that lived in `changelog-beta.md` are not carried forward.
...
- Upstream beta changelog file (`changelog-beta.md`); this file is the source of truth going forward.
...
Pre-fork release history remains in the [upstream repository](https://github.com/Threadfin/Threadfin) and its tags. This changelog starts at the maintenance-fork cleanup and does not restate every upstream beta entry.
