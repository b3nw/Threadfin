...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.files}}", "update,files.update,temp.path,cache.images,bindIpAddress,httpThreadfinDomain,forceHttps,httpsPort,httpsThreadfinDomain,xepg.replace.missing.images,xepg.replace.channel.title,tvdb.enabled,tvdb.api.key,tvdb.cache.expiry,tvdb.fallback.channel.logo,tvdb.poster.type,tvdb.episode.posters,enableNonAscii"));
